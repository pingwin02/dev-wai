...
<head>
	<meta charset="utf-8">
	<title>Kosmiczne zdjęcia - 2019</title>
...
<body>
	<div id="cointainer">
		...
		<nav>
			<ul>
				...
				<li class="lista">
					...
					<div class="lista-zaw">
						<a href="galeria"><i class="icon-lock"></i>Zgłoszone zdjęcia</a> <a href="galeria-2020">2020</a> <a class="active" href="galeria-2019">2019</a>
					</div>
				</li>
				<li class="prawo">
		...
		<div id="galeria">
			<hr class="ciemnahr">
			<h1>Galeria nagrodzonych fotografii — Rok 2019</h1>
			<figure class="zdj">
				<a href="static/images/jowisz.jpg" target="_blank"><img alt="Jowisz" src="static/images/jowisz-min.jpg"></a>
				<figcaption>
					Paweł Gazowy<br>
					<strong>Jowisz</strong>
				</figcaption>
			</figure>
			<figure class="zdj">
				<a href="static/images/zacmienie.jpg" target="_blank"><img alt="Zaćmienie Słońca" src="static/images/zacmienie-min.jpg"></a>
				<figcaption>
					Damian Jankowski<br>
					<strong>Zaćmienie Słońca</strong>
				</figcaption>
			</figure>
			<figure class="zdj">
				<a href="static/images/slonce.jpg" target="_blank"><img alt="Słońce" src="static/images/slonce-min.jpg"></a>
				<figcaption>
					Michał Gorący<br>
			...
			<figure class="zdj">
				<a href="static/images/czarna.jpg" target="_blank"><img alt="Czarna Dziura" src="static/images/czarna-min.jpg"></a>
				<figcaption>
					Krzysztof Czarny<br>
					<strong>Czarna Dziura</strong>
				</figcaption>
			</figure>
			<figure class="zdj">
				<a href="static/images/drogamleczna.jpg" target="_blank"><img alt="Droga Mleczna" src="static/images/drogamleczna-min.jpg"></a>
				<figcaption>
					Szymon Mleczny<br>
