...
<head>
	<meta charset="utf-8">
	<title>Kosmiczne zdjęcia - 2020</title>
...
<body>
	<div id="cointainer">
		...
		<nav>
			<ul>
				...
				<li class="lista">
					...
					<div class="lista-zaw">
						<a href="galeria"><i class="icon-lock"></i>Zgłoszone zdjęcia</a> <a class="active" href="galeria-2020">2020</a> <a href="galeria-2019">2019</a>
					</div>
				</li>
				<li class="prawo">
		...
		<div id="galeria">
			<hr class="ciemnahr">
			<h1>Galeria nagrodzonych fotografii — Rok 2020</h1>
			<figure class="zdj">
				<a href="static/images/wenus.jpg" target="_blank"><img alt="Wenus" src="static/images/wenus-min.jpg"></a>
				<figcaption>
					Jakub Bliski<br>
					<strong>Wenus</strong>
				</figcaption>
			...
			<figure class="zdj">
				<a href="static/images/zorze.jpg" target="_blank"><img alt="Zorza polarna" src="static/images/zorze-min.jpg"></a>
				<figcaption>
					Karolina Zimna<br>
					<strong>Zorza polarna</strong>
				</figcaption>
			</figure>
			<figure class="zdj">
				<a href="static/images/merkury.jpg" target="_blank"><img alt="Merkury" src="static/images/merkury-min.jpg"></a>
				<figcaption>
					Maciej Mały<br>
					<strong>Merkury</strong>
				</figcaption>
			</figure>
			<figure class="zdj">
				<a href="static/images/starlinki.jpg" target="_blank"><img alt="Starlinki" src="static/images/starlinki-min.jpg"></a>
				<figcaption>
					Damian Jankowski<br>
					<strong>Starlinki</strong>
				</figcaption>
			</figure>
			<figure class="zdj">
				<a href="static/images/kometaneo.jpg" target="_blank"><img alt="Kometa NEOWISE" src="static/images/kometaneo-min.jpg"></a>
				<figcaption>
					Stefan Lato<br>
					<strong>Kometa NEOWISE</strong>
				</figcaption>
			</figure>
			<div class="srodek">
